...
const labels: Record<LifecycleProvenance, string> = { USER_CONFIGURED: "user configured", NORMALIZED_CASE: "persisted evidence", REAL_PROVIDER: "real provider", REPLAY: "replay", TEST_DOUBLE: "test double", CONTROLLED_DEMONSTRATOR: "controlled demonstrator" };
