...
export type CaseGraph = { case_id: string; mode: "CASE" | "REPLAY" | "CONTROLLED_DEMONSTRATOR" | "EMPTY" | "REAL_PROVIDER" | "TEST_DOUBLE_CONTROLLED_REPLAY" | "CONFIGURED_CASE"; nodes: Array<{ id: "TARGET" | "COLLECTOR" | "OBSERVATION" | "DETECTION" | "DIAGNOSIS" | "REPAIR" | "CANDIDATE" | "VERIFICATION" | "RISK" | "COMMIT"; label: string; status: "CONFIGURED" | "ACTIVE" | "PENDING" | "ANOMALY" | "VERIFIED" | "QUARANTINED" | "BLOCKED" | "UNAVAILABLE"; provenance: "USER_CONFIGURED" | "NORMALIZED_CASE" | "REAL_PROVIDER" | "REPLAY" | "TEST_DOUBLE" | "CONTROLLED_DEMONSTRATOR"; detail: string; evidenceRefs: string[]; provider?: string }>; edges: Array<{ id: string; source: string; target: string; status: "PENDING" | "ACTIVE" | "BROKEN" | "VERIFIED" | "UNAVAILABLE"; provenance: "USER_CONFIGURED" | "NORMALIZED_CASE" | "REAL_PROVIDER" | "REPLAY" | "TEST_DOUBLE" | "CONTROLLED_DEMONSTRATOR"; evidenceRefs: string[] }>; activeNodeId: "TARGET" | "COLLECTOR" | "OBSERVATION" | "DETECTION" | "DIAGNOSIS" | "REPAIR" | "CANDIDATE" | "VERIFICATION" | "RISK" | "COMMIT"; activeEdgeIds: string[]; currentStage: "TARGET" | "COLLECTOR" | "OBSERVATION" | "DETECTION" | "DIAGNOSIS" | "REPAIR" | "CANDIDATE" | "VERIFICATION" | "RISK" | "COMMIT"; severity: "UNKNOWN" | "HEALTHY" | "ANOMALY" | "QUARANTINE" | "BLOCKED"; provenance: "USER_CONFIGURED" | "NORMALIZED_CASE" | "REAL_PROVIDER" | "REPLAY" | "TEST_DOUBLE" | "CONTROLLED_DEMONSTRATOR"; decision: "NOT_EVALUATED" | "ACCEPT" | "REJECT" | "QUARANTINE" | "BLOCKED"; evidenceRefs: string[]; message: string };
...
export type BenchmarkSummary = { status: string; classification: string; reason?: string; artifact_root?: string; summary?: Record<string, unknown>; artifacts?: string[] };
...
export const aegisApi = {
  ...
  getHistoricalProviderReplay: async () => { const payload = (await request(() => client.aegis.caseLifecycle.query({ caseId: "mission_029_real_provider" }))) as any; return { status: "AVAILABLE", presentation: "HISTORICAL_REAL_PROVIDER_EVIDENCE", artifacts: payload.graph.evidenceRefs, collection: { collector_id: payload.case.collector_id, target_url: payload.case.target_url, row_count: 150, run_behavior: "RECORDED", batch_job_id: "RECORDED" } } as RecordedReplay; },
